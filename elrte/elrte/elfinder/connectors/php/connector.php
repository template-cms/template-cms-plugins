...
$opts = array(
	'root'            => $_SERVER["DOCUMENT_ROOT"].'/data/files/',            // path to root directory
	'URL'             => 'http://'.$_SERVER['HTTP_HOST'].'/data/files/',            // root directory URL
	...
	'tmbSize'      => 96,           // images thumbnails size (px)
