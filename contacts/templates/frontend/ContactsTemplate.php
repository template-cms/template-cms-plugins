<div class="admin-heading"><?php echo lang('contacts_form'); ?></div><br />
<form action="" method="post">
<div><label><?php echo lang('contacts_subject'); ?></label></div>
<div><input type="text" value = "<?php echo $post_name; ?>" name = "contacts_subject" size = "100" /></div>
<div><label><?php echo lang('contacts_contact'); ?></label></div>
<div><input type="text" value = "<?php echo $post_contact; ?>" name = "contacts_contact" size = "100" /></div>
<div><label><?php echo lang('contacts_message'); ?></label></div>
<div><textarea name="contacts_msg" style = "width:650px;height:300px;"><?php echo $post_msg; ?></textarea></div>
